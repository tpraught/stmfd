      ...
      <Wrapper>
        ...
        <div className="pageContent">
          <span className="float-right pl-5">
						<a href="http://www.cdc.gov/co/?s_cid=carbon-monoxide-001-bb" title="Carbon Monoxide Poisoning Can Be Stopped" target="_blank"  rel="noopener noreferrer"><img src="../../assets/images/02_cdcCO.jpg" alt="Carbon Monoxide Poisoning Can Be Stopped" width="450" className="border border-secondary" /></a>
					</span>
					<ol className="ml-0">
